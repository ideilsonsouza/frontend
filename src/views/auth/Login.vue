                ...
                <div
                    ...
                    <div class="text-center mb-8">
                        ...
                        <div class="text-surface-900 dark:text-surface-0 text-3xl font-medium mb-4">Bem-vindo ao {{
                            settings.platform.name }}!</div>
                        <span class="text-muted-color font-medium">Entre para continuar</span>
                    </div>

                    <div>
                        <label for="email1"
                            class="block text-surface-900 dark:text-surface-0 text-xl font-medium mb-2">Usuário</label>
                        ...
                        <Password id="password1" v-model="password" :toggleMask="true" class="mb-4" fluid
                            :feedback="false"></Password>

                        <div class="flex items-center justify-between mt-2 mb-8 gap-8">
                            <div class="flex items-center">
                                <Checkbox v-model="checked_remember" id="checked_remember" binary class="mr-2" />
                                <label for="checked_remember">Manter connectado</label>
                            </div>
                            <span class="font-medium no-underline ml-2 text-right cursor-pointer text-primary">Esqueci
                                minha senha</span>
                        </div>
                        <Button label="Entrar" class="w-full" @click="onActionAuth()" />
                    </div>
                </div>
            </div>
        </div>
